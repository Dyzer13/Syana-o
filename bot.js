...
.addField('     **--SAunmutevoice** ' , '**To unMute memeber  --SAmutevoice **') 
.addField('     **--SAdeafen** ' , '**To Deafen memeber  --SAdeafen **') const Discord = require("discord.js");const Discord = require("discord.js");
const client = new Discord.Client();
const prefix = '--SA';
client.on('ready', () => {
...
///all Reghit Resverd 2018/2019 DyzerYT
client.login('NDc3NTY3NzczNzQ5MjgwNzY4.Dk-Ivg.8Q8ikbrk3lJ4h_B_y1gy6WTgoUE');
